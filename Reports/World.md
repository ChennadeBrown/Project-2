World Channel Predictive Modeling
================
...
```
    ...
    ##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    ##     0.0   332.0   509.0   597.3   768.0  7081.0
...
```
    ...
    ##      
    ##         M   T   W   R   F Sat Sun
    ##   No  707 870 874 872 668 159 169
    ##   Yes 649 676 691 697 637 360 398
...
![](Reports/World_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](Reports/World_files/figure-gfm/unnamed-chunk-7-2.png)<!-- -->
...
![](Reports/World_files/figure-gfm/unnamed-chunk-7-3.png)<!-- -->
...
```
    ...
    ##    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    ##   0.000   1.000   1.000   2.841   2.000 100.000
...
![](Reports/World_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->

``` r
ggpairs(xpred2, title = "Correlogram with ggpairs")
```

![](Reports/World_files/figure-gfm/unnamed-chunk-15-2.png)<!-- -->
...
![](Reports/World_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](Reports/World_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
```
    ...
    ## Summary of sample sizes: 5309, 5311, 5311, 5309, 5309, 5310, ... 
    ## Resampling results:
    ## 
    ##   RMSE      Rsquared    MAE     
    ##   6191.514  0.01173095  2026.265
    ## 
...
```
    ...
    ##    1    6251.871  0.02439330  1937.523
    ##    2    6276.880  0.02278231  1990.604
    ##    3    6298.320  0.02194774  2016.882
    ##    4    6318.994  0.02111466  2035.972
    ##    5    6341.291  0.02015209  2055.976
    ##    6    6357.220  0.01907808  2065.959
    ##    7    6369.883  0.01862614  2076.009
    ##    8    6382.900  0.01868962  2085.289
    ##    9    6394.850  0.01829563  2093.594
    ##   10    6407.144  0.01781034  2098.391
    ## 
...
```
    ...
    ## RMSE                         4183.925     4168.312         4179.482      4163.989
...
```
    ...
    ##                       RMSE
    ## LinearModelOne    4179.482
    ## LinearModelBckSel 4183.925
    ## rForest           4163.989
    ## boostedTree       4168.312
